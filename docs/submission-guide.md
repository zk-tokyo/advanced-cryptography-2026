...
Python穴埋め課題の場合は、課題文で指定された `solution.py` を提出します。
...
git switch -c submit/week0-<your-name>
```

例:

```bash
git switch -c submit/week0-alice
```
...
```bash
mkdir -p week0/exercises/submissions/<your-name>
code week0/exercises/submissions/<your-name>/answer.md
```

Python穴埋め課題を提出する場合は、テンプレートをコピーして `solution.py` を作成してください。

```bash
cp week0/exercises/templates/solution.py week0/exercises/submissions/<your-name>/solution.py
code week0/exercises/submissions/<your-name>/solution.py
```

`code` コマンドが使えない場合は、好きなエディタで提出ファイルを作成してください。

### 6. commitしてpushする

```bash
git status
git add week0/exercises/submissions/<your-name>/answer.md
git commit -m "submit week0"
git push -u origin submit/week0-<your-name>
```

Python穴埋め課題の場合は、`answer.md` の代わりに `solution.py` をaddしてください。
...
compare branch: submit/week0-<your-name>
```
...
```text
week0/exercises/submissions/alice/answer.md
week0/exercises/submissions/bob/answer.md
```
...
Python穴埋め課題の採点結果は、GitHub Actionsの `python-grade` check summaryに表示されます。

合格点は現在 `70点` です。70点以上の場合、`auto-grade` check がpassします。
Python穴埋め課題では、70点以上の場合に `python-grade` check がpassします。
