...
def beaver_multiply(
    ...
    # ... + de
    party = 0
    result[party] = (result[party] + d * e) % modulus
    return result
...
def ot_sender_encrypt(
    ...
    branch_1_base = request * pow(sender_public, -1, OT_P) % OT_P
...
def gmw_and(
    ...
    y_0, y_1 = y_shares
    r_01, r_10 = masks
    secret_01, secret_10 = ot_secrets
    ...
    return (
        (x_0 & y_0) ^ r_01 ^ cross_10,
        (x_1 & y_1) ^ r_10 ^ cross_01,
    )
